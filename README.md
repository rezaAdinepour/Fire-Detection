...
In this application, which is written in C++ and MFC API, can Detect Fire on image ![GitHub watchers](https://img.shields.io/github/watchers/rezaAdinepour/Fire-Detection)
